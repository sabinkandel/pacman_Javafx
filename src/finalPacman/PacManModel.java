...
public class PacManModel {
    ...
    public static int sps = 50;
    /**
     * Start a new game upon initializion
     */
    public PacManModel(int l) {
    	this.level = l;
        this.startNewGame();
    }
     ...
     *
     *  fileName txt file containing the board configuration
     */
    ...
    public void startNewGame() {
        ...
        this.score = 0;
        this.level = level;
        this.initializeLevel(Controller.getLevelFile(UsrData.getlevel()-1));
    }
    ...
    public void startNextLevel() {
        if (this.isLevelComplete()) {
            ...
            try {
                this.initializeLevel(Controller.getLevelFile(UsrData.getlevel()));
            }
     ...
     *  velocity the current velocity of the specified ghost
     ...
     *  objectLocation the specified object's location
